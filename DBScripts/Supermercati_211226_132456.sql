...
-- Riga ordine_Prodotto [rel9]
alter table `riga_ordine`  add column  `prodotto_oid`  integer;
alter table `riga_ordine`   add index fk_riga_ordine_prodotto (`prodotto_oid`), add constraint fk_riga_ordine_prodotto foreign key (`prodotto_oid`) references `prodotto` (`oid`);
